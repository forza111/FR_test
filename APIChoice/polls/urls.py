...
urlpatterns = ([
    ...
    path("admin/question/<int:pk>", admin.AdminQuestionViewSet.as_view({'get': 'retrieve'})),
    ...
    path("admin/type_question/<int:pk>", admin.AdminTypeQuestionViewSet.as_view({'get': 'retrieve'})),
